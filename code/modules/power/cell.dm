...
/obj/item/stock_parts/power_store/cell/get_cell()
	return src

/obj/item/stock_parts/power_store/cell/Initialize(mapload, override_maxcharge)
	. = ..()

/obj/item/stock_parts/power_store/cell/create_reagents(max_vol, flags)
	. = ..()
	RegisterSignal(reagents, COMSIG_QDELETING, PROC_REF(on_reagents_del))

/// Handles properly detaching signal hooks.
/obj/item/stock_parts/power_store/cell/proc/on_reagents_del(datum/reagents/reagents)
	SIGNAL_HANDLER
...
/obj/item/stock_parts/power_store/cell/infinite/use(amount, force)
	..()
	return TRUE
